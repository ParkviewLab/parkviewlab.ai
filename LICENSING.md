...
This repository is the **parkviewlab.ai** website. It is **standard copyright** —
*not* open source. Its first-party files (HTML, CSS, build scripts, written
content, and the ParkviewLab brand marks/logos) may not be used, copied, modified,
or distributed except as expressly authorized in writing by the copyright holder.
...
| Bucket | License |
|---|---|
| Site, scripts, content, brand marks (`assets/img/`) | `LicenseRef-AllRightsReserved` (all rights reserved) |
